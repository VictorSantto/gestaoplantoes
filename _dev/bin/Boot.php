...
# CMS urls
RewriteRule ^cms/([^/]*)/all/?\$ mod/cms/Getz.php?method=stateReadAll&code=&search=&position=1&screen=\$1&base=&order= [NC,L]
...
RewriteRule ^cms/([^/]*)/called/([0-9]*)/all/historyBack/(\-?[0-9]*)/?\$ mod/cms/Getz.php?method=stateCalledAll&code=&search=&position=1&screen=\$1&base=\$2&order=&historyBack=\$3 [NC,L]
