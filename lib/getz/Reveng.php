...
php \"%BIN_TARGET%\" %*";
	 ...
	 */ ";			
					...
					$script .= $this->getFkFields($row["table"]);
...
del \"%BIN_TARGET%\" %*");	
	...
	\$fkFields = array(";
			...
			while ($row = $result->fetch_assoc()) {
				if ($cont == 0)
					$fks .= "\"" . $row["referenced_table_name"] . "\" => \"standard\"";
				else {
					$fks .= ",
			\"" . $row["referenced_table_name"] . "\" => \"standard\"";
				}
	...
	\$fields = array(";		
		...
		public function getTypes($column, $type) { 
			if (strtoupper($column) == "ID")
				...
				return "cep";
			else if (strtoupper($column) == "EMAIL")
				return "email";
			else if (strtoupper($column) == "TELEFONE" || strtoupper($column) == "PHONE")
				return "phone";
			else if (strtoupper($column) == "CELULAR" || strtoupper($column) == "CELLPHONE")
				return "cellphone";
			else if (strtoupper($column) == "ORDEM")
				return "order";
			else if (strtoupper($column) == "ORDER")
				return "order";
