<?php 
	 ...
	 */
	$fk = array("unidades" => "unidade",
			"unidade_cargos" => "unidade_cargo"
	);
	 ...
	 */ 
	$fkFields = array("unidades" => "standard",
			"unidade_cargos" => "standard"
	);
